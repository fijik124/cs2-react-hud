    ...
    >
      <div className="player_data">
        <div className="player_stats">
          <div className={`bombOrDefuse ${player.team.orientation}`}></div>
          <Bomb player={player} />
          <Defuse player={player} />
          <div className="playerCardWrapper">
          <div className="mainPanelBackground"></div>
          ...
          ></div>
          <div className={`kdMoney ${player.team.orientation}`}>
            <div className={`playerKillsIcon ${player.team.orientation}`}>
              <div className={`playerKillsText ${player.team.orientation}`}>
                {player.stats.kills}
              </div>
            </div>
            <div className={`playerDeathsIcon ${player.team.orientation}`}>
              <div className={`playerDeathsText ${player.team.orientation}`}>
                {player.stats.deaths}
              </div>
            </div>
            <div className={`playerMoney ${player.team.orientation}`}>
              ${player.state.money}
            </div>
          </div>
          <div className="utilityWeapons">
            {primary || secondary ? (
              <Weapon
